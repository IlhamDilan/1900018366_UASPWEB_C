...
<body class="warna">
    ...
    <div class="container is-fluid ">
        <div class="notification has-text-centered has-background-primary-light">
            <strong>--Selamat Datang di AnimeNews--</strong>
        </div>
    </div>
              ...
              <div class="tile is-child box has-background-info-light">
                    <article class="media">
                            <div class="media-left">
                                <figure class="image is-128x128">
                                    <img src="gambar/cs.jpg">
                                </figure>
                            </div>
                            <div class="media-content">
                                <div class="content has-text-centered">
                                    <p class="title">Anime Laris, Tidak dengan Manganya!</p>
                                    ...
                                    <div class="buttons are-medium has-addons is-centered">
                                        <a href="#"><button class="button">Klik</button></a>
                                    </div>
                                </div>
                            </div>
                    </article>
                ...
                <div class="tile is-child box has-background-warning-light">
                    <article class="media">
                            <div class="media-left">
                                <figure class="image is-128x128">
                                    <img src="gambar/nrt.jpg">
                                </figure>
                            </div>
                            <div class="media-content">
                                <div class="content has-text-centered">
                                    <p class="title">From Zero to Hero</p>
            ...
            <div class="tile is-vertical is-4 is-parent">
                <div class="tile is-child box has-background-info-light">
                    <article class="media">
                            <div class="media-left">
                                <figure class="image is-128x128">
                                    <img src="gambar/wp4368520.jpg">
                                </figure>
                            </div>
                            <div class="media-content">
                                <div class="content has-text-centered">
                                    <p class="title">Isekai yang Kawai</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna eros, eu pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam finibus odio quis feugiat facilisis.</p>
                                    <div class="buttons are-medium has-addons is-centered">
                                        <a href="#"><button class="button">Klik</button></a>
                                    </div>
                ...
                <div class="tile is-child box has-background-warning-light">
                    <article class="media">
                            <div class="media-left has-text-centered">
                                <figure class="image is-128x128">
                                    <img src="gambar/hataraku.jpg">
                                </figure>
                            </div>
                            <div class="media-content">
                                <div class="content has-text-centered">
                                    <p class="title">MC yang Overpower</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna eros, eu pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam finibus odio quis feugiat facilisis.</p>
                                    <div class="buttons are-medium has-addons is-centered">
                                        <a href="#"><button class="button">Klik</button></a>
                                    </div>
            ...
            <div class="tile is-vertical is-4 is-parent">
                <div class="tile is-child box has-background-info-light">
                        <article class="media">
                                <div class="media-left">
                                    <figure class="image is-128x128">
                                        <img src="gambar/kg.jpg">
                                    </figure>
                                </div>
                                <div class="media-content">
                                    <div class="content has-text-centered">
                                        <p class="title">Cinta Menjadi Perang</p>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna eros, eu pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam finibus odio quis feugiat facilisis.</p>
                                        <div class="buttons are-medium has-addons is-centered">
                                            <a href="#"><button class="button">Klik</button></a>
                                        </div>
                ...
                <div class="tile is-child box has-background-warning-light">
                    <article class="media">
                            <div class="media-left">
                                <figure class="image is-128x128">
                                    <img src="gambar/kn.jpg">
                                </figure>
                            </div>
                            <div class="media-content">
                                <div class="content has-text-centered">
                                    <p class="title">Slice of Life yang Seru</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna eros, eu pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam finibus odio quis feugiat facilisis.</p>
                                    <div class="buttons are-medium has-addons is-centered">
                                        <a href="#"><button class="button">Klik</button></a>
                                    </div>
